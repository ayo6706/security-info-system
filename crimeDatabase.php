...
<head>
  <title>Crime Database - Security Infosystem</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Crime Database</a>
          </div>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                   ...
                   Date
                    ...
                    <td><a href="officers_profile.php?vad='.$row["officer_in_charge"].'"> 
